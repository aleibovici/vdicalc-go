...
func Calculate(fullData map[string]interface{}, r *http.Request) {
	...
	fullData["virtualizationresultsclustercount"] = virtualization.GetClusterSize(r.FormValue("vmcount"), r.FormValue("hostsocketcount"), r.FormValue("hostsocketcorescount"), r.FormValue("vmpercorecount"), r.FormValue("hostcoresoverhead"), r.FormValue("virtualizationclusterhostsize"))
