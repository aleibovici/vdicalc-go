...
func Calculate(fullData map[string]interface{}, r *http.Request) bool {
	...
	fullData["azureresultsinstancetype"] = azure.GetAzureInstanceType(r.FormValue("vmvcpucount"), r.FormValue("vmmemorysize"), r.FormValue("vmdisksize"), r.FormValue("vmvideoram"))
