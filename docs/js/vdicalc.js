...
// ============================================================
// localStorage Save/Load (replaces MySQL database)
// ============================================================

var STORAGE_KEY = "vdicalc_saves";
...
// All form field IDs for save/load
var formFields = [
  "vmcount", "vmvcpucount", "vmvcpumhz", "vmpercorecount", "vmmemorysize",
  "vmdisplaycount", "vmdisplayresolution", "vmvideoram", "vmdisksize",
  "vmiopscount", "vmiopsreadratio", "vmiopsbootcount", "vmiopsbootreadratio",
  "vmclonesizerefreshrate", "hostsocketcount", "hostsocketcorescount",
  "hostmemoryoverhead", "hostcoresoverhead", "storagecapacityoverhead",
  "storagedatastorevmcount", "storagededuperatio", "storageraidtype",
  "storageconcurrentbootvmcount", "virtualizationclusterhostsize",
  "virtualizationclusterhostha", "virtualizationmanagementservertvmcount"
];
...
function loadConfig() {
  var select = document.getElementById("usersaves");
