...
func DataLoad(class config.Configurations) map[string]interface{} {
	...
	data := map[string]interface{}{
		...
		"vmiopsbootcount":                class.VM.Iopsbootcount,
		"vmiopsbootcountselected":        class.VM.Iopsbootcountselected,
		"vmiopsbootcountlabel":           class.VM.Iopsbootcountlabel,
		"vmiopsbootcounttooltip":         class.VM.Iopsbootcounttooltip,
		"vmiopsbootreadratio":            class.VM.Iopsbootreadratio,
		"vmiopsbootreadratioselected":    class.VM.Iopsbootreadratioselected,
		"vmiopsbootreadratiolabel":       class.VM.Iopsbootreadratiolabel,
		"vmiopsbootreadratiotooltip":     class.VM.Iopsbootreadratiotooltip,
		...
		"storageconcurrentbootvmcount":         class.Storage.Concurrentbootvmcount,
		"storageconcurrentbootvmcountlabel":    class.Storage.Concurrentbootvmcountlabel,
		"storageconcurrentbootvmcountselected": class.Storage.Concurrentbootvmcountselected,
		"storageconcurrentbootvmcounttooltip":  class.Storage.Concurrentbootvmcounttooltip,
