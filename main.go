...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		case "update":
			...
			fullData["errorresults"] = validation.ValidateHostResults(fullData["hostresultsclockused"], r.FormValue("virtualizationmanagementservertvmcount"), r.FormValue("vmmemorysize"))
